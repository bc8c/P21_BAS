...
type CodeInfo struct {
	...
	Hash_code       [32]byte `json:"Hash_code"`
...
type TokenInfo struct {
	...
	DID_client      string   `json:"DID_client"`
	Scope           string   `json:"Scope"`
	Hash_token      [32]byte `json:"Hash_code"`
	Time_issueed    string   `json:"Time_issueed"`
...
func (s *SmartContract) InitLedger(ctx contractapi.TransactionContextInterface) error {
	...
	mCodeInfo := CodeInfo{InfoType: `CodeInfo`, ID_code: "TestCID", DID_RO: "TestDIDRO", DID_client: "TESTDIDClient", Scope: "all", Hash_code: [32]byte{0}, Time_issueed: "TestTime", URI_Redirection: "TESTURI", Condition: "Available", ID_token: "TestTID"}

	mTokenInfo := TokenInfo{InfoType: `TokenInfo`, ID_token: "TestTID", DID_RO: "TestDIDRO", DID_client: "TESTDIDClient", Scope: "all", Hash_token: [32]byte{0}, Time_issueed: "TestTime", Time_expiration: "TestDuration", URI_Redirection: "TESTURI", Condition: "Available"}
...
func (s *SmartContract) UpdateCodeInfo(ctx contractapi.TransactionContextInterface, pID_code string, pDID_RO string, pDID_client string, pScope string, pHash_code [32]byte, pTime_issueed string, pURI_Redirection string, pCondition, string, pID_token string) error {
